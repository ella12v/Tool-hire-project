...
public class Diary
{
    ...
    */
   public void addReservation(ShopItemReservation shopItemReservation)
   {
    ...
    * @parameter     shopItemReservation, of type ShopItemReservation 
    */   
   public void deleteReservation(ShopItemReservation shopItemReservation)
   {
      Date date = shopItemReservation.getStartDate();
      for(int day=1; day<=shopItemReservation.getNoOfDays(); day++)
      {
    ...
    */   
   public ShopItemReservation[] getReservations(Date date)
   {
      DayInDiary dayinDiary = dayInDiaryMap.get(date);
      if( dayinDiary==null )
         return null;
      ...
      private void printEntries()
      {
         ...
         if( size>0 )
         {
            ...
            for( Entry entry: daysEntries )
            {
               ...
               System.out.println("    " + shopItemReservation.toString() + ", day " + reservationDay + " of " + shopItemReservation.getNoOfDays());
            }
         }
         else
         {
